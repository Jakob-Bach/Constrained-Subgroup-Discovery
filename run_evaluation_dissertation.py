...
Script to compute summary statistics and create plots + tables for the dissertation. Should be run
after the experimental pipeline, as this evaluation script requires the pipeline's outputs as
inputs.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Creates the dissertation\'s plots + tables and prints statistics.',

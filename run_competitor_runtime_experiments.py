...
SD_METHODS = {
    ...
    'pysubgroup.Apriori': runtime_competitors.Pysubgroup_Apriori,
    'pysubgroup.Beam': runtime_competitors.Pysubgroup_BeamSearch,
    'pysubgroup.DepthFirst': runtime_competitors.Pysubgroup_SimpleDFS,
    'pysubgroup.GPGrowth': runtime_competitors.Pysubgroup_GpGrowth,
